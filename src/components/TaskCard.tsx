...
function TaskCard({ task, dispatch, setEditingTask }: TaskCardProps) {
    ...
    return (
        <>
            <div className="p-5 bg-white mt-4 flex justify-between items-start rounded-lg border border-gray-400 shadow-lg">
